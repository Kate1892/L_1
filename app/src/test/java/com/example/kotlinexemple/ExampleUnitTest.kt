package com.example.kotlinexemple

import com.example.kotlinexemple.extentions.UserHolder
...
class ExampleUnitTest {
    ...
    @Test(expected = IllegalArgumentException::class)
    fun register_user_fail_illegal_phone() {
        val holder = UserHolder
        holder.registerUserByPhone("John Doe", "+7nb(917) 971 11-11")
    }
    ...
    @Test(expected = IllegalArgumentException::class)
    fun register_user_fail_illegal_exist2() {
        val holder = UserHolder
    ...
    @Test(expected = IllegalArgumentException::class)
    fun register_user_fail_phone_illegal_exist() {
        val holder = UserHolder
        holder.registerUserByPhone("John Doe", "+7 (917) 971-11-11")
        holder.registerUserByPhone("John Doe", "+7 (917) 971-11-11")
    }
